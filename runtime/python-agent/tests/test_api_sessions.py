...
def _create_project(client, project_id: str) -> str:
    resp = client.post(
        "/v1/projects",
        json={
...
def test_create_and_list_sessions(isolated_client):
...
def test_rename_session(isolated_client):
...
def test_sessions_validation_errors(isolated_client):
    client = isolated_client
