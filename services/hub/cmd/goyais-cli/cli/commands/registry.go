...
var defaultCommandSpecs = []Spec{
	...
	{Path: []string{"session"}, Declaration: "session"},
	{Path: []string{"session", "start"}, Declaration: "start"},
	{Path: []string{"session", "list"}, Declaration: "list"},
	{Path: []string{"session", "get"}, Declaration: "get <session_id>"},
	{Path: []string{"run"}, Declaration: "run"},
	{Path: []string{"run", "submit"}, Declaration: "submit"},
	{Path: []string{"run", "control"}, Declaration: "control"},
	{Path: []string{"run", "stream"}, Declaration: "stream"},
