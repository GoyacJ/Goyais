...
// CompletionKind is the semantic source of one completion suggestion.
...
// CompletionSuggestion is one completion candidate.
...
// CompletionRequest defines the input context for completion generation.
...
// CompletionEngine provides token-based completion over slash, mention, path,
// and unix command domains.
...
// NewCompletionEngine constructs a completion engine with sensible cache TTL.
...
// Suggest returns completion candidates ranked by score and deterministic tie
// ordering.
