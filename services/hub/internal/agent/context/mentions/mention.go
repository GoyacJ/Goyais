...
// AgentMentionKind describes semantics of an agent mention token.
...
// AgentMention captures one parsed mention marker.
...
// MentionProcessingResult contains rewritten prompt plus mention metadata.
...
// ProcessMentions extracts @run-agent-* and @ask-* markers, validates them
// against known agents, and prepends stable routing directives to the prompt.
