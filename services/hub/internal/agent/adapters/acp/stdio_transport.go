...
// StdioTransport adapts newline-delimited JSON-RPC over stdio.
...
// StdioTransportOptions configures stdio transport dependencies.
...
// Start blocks until context cancellation or input EOF/error.
