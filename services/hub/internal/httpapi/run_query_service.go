...
func newRunQueryService(state *AppState) (*runQueryService, bool) {
...
func (s *runQueryService) ListExecutions(ctx context.Context, filter runQueryFilter) ([]Execution, *string, error) {
	if s == nil {
...
func (s *runQueryService) ListAllByConversation(ctx context.Context, conversationID string) ([]Execution, error) {
	if s == nil {
...
func (s *runQueryService) ComputeTokenUsageAggregate(ctx context.Context, workspaceIDs []string) (tokenUsageAggregate, error) {
...
func (s *runQueryService) ComputeConversationTokenUsage(ctx context.Context, conversationIDs []string) (map[string]tokenUsageTotals, error) {
...
func (s *runQueryService) listAllRuntimeSessionsByWorkspace(ctx context.Context, workspaceID string) ([]RuntimeSessionRecord, error) {
...
func (s *runQueryService) listAllRuntimeRunsByWorkspace(ctx context.Context, workspaceID string) ([]RuntimeRunRecord, error) {
	items := []RuntimeRunRecord{}
	offset := 0
	for {
...
func (s *runQueryService) listAllRuntimeRunsByConversation(ctx context.Context, conversationID string) ([]RuntimeRunRecord, error) {
	items := []RuntimeRunRecord{}
	offset := 0
	for {
