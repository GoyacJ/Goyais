...
// Package httpapi defines Hub runtime repository contracts used by
...
const (
	hubRuntimeSchemaComponent = "hub_runtime"
	hubRuntimeSchemaVersion   = "1"
)
...
// RuntimeRepositorySet groups all runtime repositories for service wiring.
type RuntimeRepositorySet struct {
