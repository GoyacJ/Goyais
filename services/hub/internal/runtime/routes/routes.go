...
type Handlers struct {
	...
	ConversationRollback         http.HandlerFunc
...
func Register(mux *http.ServeMux, handlers Handlers) {
	...
	mustHandle(mux, "/v1/projects/{project_id}/conversations", handlers.ProjectConversations)
	...
	mustHandle(mux, "/v1/conversations", handlers.Conversations)
	mustHandle(mux, "/v1/conversations/{conversation_id}", handlers.ConversationByID)
	mustHandle(mux, "/v1/conversations/{conversation_id}/input/catalog", handlers.ConversationInputCatalog)
	mustHandle(mux, "/v1/conversations/{conversation_id}/input/suggest", handlers.ConversationInputSuggest)
	mustHandle(mux, "/v1/conversations/{conversation_id}/input/submit", handlers.ConversationInputSubmit)
	mustHandle(mux, "/v1/conversations/{conversation_id}/events", handlers.ConversationEvents)
	mustHandle(mux, "/v1/conversations/{conversation_id}/stop", handlers.ConversationStop)
	mustHandle(mux, "/v1/conversations/{conversation_id}/export", handlers.ConversationExport)
	mustHandle(mux, "/v1/conversations/{conversation_id}/changeset", handlers.ConversationChangeSet)
	mustHandle(mux, "/v1/conversations/{conversation_id}/changeset/commit", handlers.ConversationChangeSetCommit)
	mustHandle(mux, "/v1/conversations/{conversation_id}/changeset/discard", handlers.ConversationChangeSetDiscard)
	mustHandle(mux, "/v1/conversations/{conversation_id}/changeset/export", handlers.ConversationChangeSetExport)
	mustHandle(mux, "/v1/conversations/{conversation_id}/rollback", handlers.ConversationRollback)
	mustHandle(mux, "/v1/executions", handlers.Executions)
