...
func writeCommandError(w http.ResponseWriter, err error) {
	...
	if errors.As(err, &execErr) && strings.TrimSpace(execErr.Code) != "" && strings.TrimSpace(execErr.MessageKey) != "" {
		...
		case "INVALID_COMMAND_REQUEST", "INVALID_ASSET_REQUEST", "INVALID_SHARE_REQUEST", "INVALID_WORKFLOW_REQUEST", "INVALID_PLUGIN_REQUEST", "INVALID_STREAM_REQUEST":
			status = http.StatusBadRequest
		case "PLUGIN_NOT_FOUND", "STREAM_NOT_FOUND":
