...
type Repository interface {
	...
	GetAssetForShare(ctx context.Context, req RequestContext, assetID string) (ShareAsset, error)
	HasAssetPermission(ctx context.Context, req RequestContext, assetID, permission string, now time.Time) (bool, error)
